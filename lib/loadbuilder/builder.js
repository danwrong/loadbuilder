...
function Builder(options) {
  ...
  if (this.options.aliases) {
    this.alias(this.options.aliases);
  }
  this.matchers = [];
...
util.extend(Builder.prototype, {
  ...
  alias: function(aliases) {
    util.extend(this.aliases, aliases);
    var newAssetsFromAlias = [];
    this.assets = this.assets.filter(function(asset) {
      if (aliases.hasOwnProperty(asset.id)) {
        newAssetsFromAlias.push(aliases[asset.id]);
        return false;
      }
      return true;
    }, this);
    this.assets.concat(newAssetsFromAlias);
    delete this.source;
    return this;
  },
